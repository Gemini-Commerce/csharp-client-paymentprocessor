...
namespace paymentprocessor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "paymentprocessorItem")]
    public partial class PaymentprocessorItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentprocessorItem" /> class.
        /// </summary>
        ...
        public PaymentprocessorItem(string id = default(string), string productGrn = default(string), long qtyOrdered = default(long), long qtyCommitted = default(long), PaymentprocessorMoney unitSalePrice = default(PaymentprocessorMoney), PaymentprocessorMoney unitListPrice = default(PaymentprocessorMoney), PaymentprocessorMoney unitBasePrice = default(PaymentprocessorMoney), PaymentprocessorMoney unitVatAmount = default(PaymentprocessorMoney), PaymentprocessorMoney rowSalePrice = default(PaymentprocessorMoney), PaymentprocessorMoney rowListPrice = default(PaymentprocessorMoney), PaymentprocessorMoney rowVatAmount = default(PaymentprocessorMoney), PaymentprocessorMoney discountAmount = default(PaymentprocessorMoney), PaymentprocessorMoney rowBasePrice = default(PaymentprocessorMoney), float vatPercentage = default(float), bool vatInaccurate = default(bool), bool vatCalculated = default(bool), string productName = default(string), string productCode = default(string), string productSku = default(string), string productOptions = default(string), string productImg = default(string), string productData = default(string), string shipmentInfoReference = default(string), List<string> promotionGrn = default(List<string>), bool productIsVirtual = default(bool))
        {
            this.Id = id;
