...
namespace paymentprocessor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "paymentprocessorCreatePaymentMethodRequest")]
    public partial class PaymentprocessorCreatePaymentMethodRequest : IValidatableObject
    {
        ...
        public PaymentprocessorCreatePaymentMethodRequest(string tenantId = default(string), string code = default(string), PaymentprocessorLocalizedText title = default(PaymentprocessorLocalizedText), PaymentprocessorLocalizedText label = default(PaymentprocessorLocalizedText), bool enabled = default(bool), PaymentprocessorMoney amount = default(PaymentprocessorMoney), PaymentprocessorCurrency? currency = default(PaymentprocessorCurrency?), Object varConfiguration = default(Object), bool isUpfront = default(bool), PaymentprocessorLocalizedText description = default(PaymentprocessorLocalizedText), List<PaymentprocessorPaymentMethodRestriction> restrictions = default(List<PaymentprocessorPaymentMethodRestriction>))
        {
            // to ensure "tenantId" is required (not null)
            if (tenantId == null)
            {
                throw new ArgumentNullException("tenantId is a required property for PaymentprocessorCreatePaymentMethodRequest and cannot be null");
            }
            this.TenantId = tenantId;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for PaymentprocessorCreatePaymentMethodRequest and cannot be null");
            }
            this.Code = code;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for PaymentprocessorCreatePaymentMethodRequest and cannot be null");
            }
            this.Title = title;
            this.Label = label;
