...
namespace paymentprocessor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "paymentprocessorMoney")]
    public partial class PaymentprocessorMoney : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentprocessorMoney" /> class.
        /// </summary>
        ...
        public PaymentprocessorMoney(string units = default(string), int micros = default(int))
        {
            this.Units = units;
            this.Micros = micros;
        }
