...
namespace paymentprocessor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "paymentprocessorPostalAddress")]
    public partial class PaymentprocessorPostalAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentprocessorPostalAddress" /> class.
        /// </summary>
        ...
        public PaymentprocessorPostalAddress(int revision = default(int), string regionCode = default(string), string languageCode = default(string), string postalCode = default(string), string sortingCode = default(string), string administrativeArea = default(string), string locality = default(string), string sublocality = default(string), List<string> addressLines = default(List<string>), List<string> recipients = default(List<string>), string organization = default(string), string phoneNumber = default(string), Object additionalInfo = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentprocessorPostalAddress {\n");
